...
class m160520_123151_create_yandex_fotki__photo extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->createTable('yandex_fotki__photo', [
            ...
            'accessId'           => $this->string(7)->notNull(),
        ...
        $this->addForeignKey(
            'yandex_fotki__photo___accessId___yandex_fotki__photo_access___id',
            'yandex_fotki__photo',
            'accessId',
    ...
    public function safeDown()
    {
        ...
        $this->dropForeignKey('yandex_fotki__photo___accessId___yandex_fotki__photo_access___id', 'yandex_fotki__photo');
